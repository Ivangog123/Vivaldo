...
app.post('/api/chat-medico', async (req, res) => {
    ...
    try {
        ...
        const systemInstruction = `Você é um assistente médico especializado em pré-diagnóstico em Portugal.
...
Use linguagem clara e empática. Responda em português de Portugal.`;
